...
int main(int argc, char **argv)
{
    ...
    U16 AdRanges[NumChans] = {AD_B_5_V, AD_B_5_V, AD_B_5_V, AD_B_5_V};
    U16 Chans[NumChans] = {0, 15, 1, 8};
    U16 BufferId;
    F64 voltage = 0.0;
    FILE* fout;
    int i, j;
    ...
    err = AI_ContReadMultiChannels(card, NumChans, Chans, AdRanges, &BufferId, ReadCount, 0, SYNCH_OP); 
    if(err < 0){
