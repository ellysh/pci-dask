...
/* Date    : 2009/06/02                                                       */
/*                                                                            */
/* This sample performs continuous DO update with external trigger.           */
/* The sample updates 65536 32-bits samples to DIO Port A/B/C/D with 50MHz    */
/* internal sampled clock while the set start trigger is asserted.            */
/*----------------------------------------------------------------------------*/
//#include <windows.h>
#include <stdio.h>
#include <stdlib.h>
...
int main(int argc, char **argv)
{
    ...
    printf("This sample performs continuous DO Update with external\n");
    printf("trigger (AFI0) at %lf sample rate.\n\n", SampleRate);
    printf("Card Number? ");
    scanf(" %hd", &card_num);
     ...
     */
    printf("\nPress any key to start DO operation with external trigger.");
    ...
    printf("\n\nWait external trigger from AFI0...");
    do{
