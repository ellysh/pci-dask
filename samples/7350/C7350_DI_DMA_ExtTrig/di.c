...
/* Date    : 2009/06/07                                                       */
/*                                                                            */
/* This sample performs continuous DI acquisition with external trigger.      */
...
int main(int argc, char **argv)
{
    ...
    printf("This sample performs continuous DI acquisition with\n");
    printf("external trigger (AFI0) at %lf sample rate.\n\n", SampleRate);
    printf("Card Number? ");
    scanf(" %hd", &card_num);
