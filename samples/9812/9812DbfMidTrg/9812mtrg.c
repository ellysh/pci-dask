...
void * ProcessThread( void * temp_pt )
{
    ...
    fprintf( fp, "Double Buffer Transfer With Middle Trigger operation\n");
...
int main(void)
{
    ...
    setbuf( stdout, NULL );
    printf("Double Buffer Transfer With Middle Trigger operation\n");
    ...
    err = AI_9812_Config(card,P9812_TRGMOD_MIDL, P9812_TRGSRC_EXT_DIG, P9812_TRGSLP_POS, P9812_AD2_GT_PCI|P9812_CLKSRC_INT,0,postCount);
    if (err!=0) {
