...
int main( void )
{
    ...
    setbuf( stdout, NULL );
    printf("PCI-9118 Double Buffered DMA with Post Trigger Mode\n");
    ...
    fprintf( fp, "PCI-9118 Double Buffered DMA with Post Trigger Mode\n");
    fprintf( fp, "count_per_page:%li\n", read_count );
    fprintf( fp, "channel_num:1\n" );
    fprintf( fp, "sample_rate(Hz):%li\n", (U32)sample_rate );
    fprintf( fp, "CH0\n======================\n");
    printf("\n\n\n Data conversion start , Input the Trigger Signal for  Post Trigger operation\n");
